...
public class WordCountHDFS {
    ...
    public static void main(String[] args) {
        ...
        //SparkConf conf  =new SparkConf().setAppName("JavaWorldCount").setMaster("spark://hadoop100:7077")
          //      .set("spark.driver.host","hadoop100").set("spark.driver.port","4040");
        JavaSparkContext jsc = new JavaSparkContext(conf);
        //读取数据
        JavaRDD<String> lines = jsc.textFile("hdfs://hadoop100:9000/input");
        //扁平化
        ...
        //保存数据
        result.saveAsTextFile("hdfs://hadoop100:9000/spark/output");
